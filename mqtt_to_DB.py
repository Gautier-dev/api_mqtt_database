...
def on_message(client, userdata, msg):
    ...
    cur.execute("INSERT INTO Measure (data, date, id_sendor) VALUES (%s,%s,%s)", (str(msg.payload), str(datetime.datetime.now()), 1))
    # Make it persistent
    conn.commit()
...
client.connect("surveillancedevieux-mqtt2.apps.asidiras.dev", 1883, 60)
